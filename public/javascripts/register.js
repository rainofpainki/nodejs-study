...
var idCheck = function() {
  if( !lengthCheck("#id", "#idMsg", 5, 20) )    return false;
  if( !patternCheck( '#id', '#idMsg', patternObj.symbol.pattern, patternObj.symbol.msg) )
    return false;
  if(!patternCheck('#id', '#idMsg', patternObj.korean.pattern, patternObj.korean.msg))
    return false;
  if(!patternCheck('#id', '#idMsg', patternObj.blank.pattern, patternObj.blank.msg))
    return false;
...
$(document).on("click", "#register", function() {
  if($("#registerForm").valid()) {
    if(idCheck() && pswd1Check() && pswd2Check() && nameCheck()) {
